...
--
-- Host: localhost
-- Generation Time: Dec 15, 2020 at 03:14 PM
...
('2', '12345', 'Ferizalsyah', 'pakjo', '087656543423', '');
...
INSERT INTO `tb_anggota` (`id_anggota`, `nama`, `id_kelas`, `id_agama`, `jenis_kelamin`, `hp`, `alamat`, `ket`, `email`, `password`) VALUES
('ANGG000002', 'Abdullah', 4, 2, 'L', '019273981293871', 'tidak tau', 'belum ade keterangan', 'abdullah@gmail.com', '12345'),
('ANGG000003', 'Ariandi AS', 4, 2, 'L', '085382005325', 'dw', 'fdw', 'ariandi@gmail.com', '2345'),
('ANGG000004', 'sukoco', 5, 3, 'L', '087798789955', 'jln. jembatan merah', 'siswa', 'sukoco@gmail.com', '3456'),
('ANGG000005', 'Tri Gunawan', 6, 3, 'L', '345678909123981', 'test', 'belum nikah tapi sudah . . .', 'gunawan@gmail.com', '45678'),
('ANGG000006', 'Matinun amin', 5, 3, 'L', 'eeeee', 'wwwwwww', 'wwww', 'ferizalsyah1998@gmail.com', 'qweerrrr');
...
INSERT INTO `tb_buku` (`id_buku`, `ISBN`, `judul`, `id_kategori`, `id_penerbit`, `id_pengarang`, `no_rak`, `thn_terbit`, `stok`, `ket`, `foto`) VALUES
('09', '12222222', 'hiiiiia', 4, 1, 1, 2, 2020, 5, 'addddd', NULL),
('1', '1244242', 'Machine Learning', 4, 1, 1, 1, 2017, 20, '', NULL),
('12', '234556', 'hujoo', 4, 4, 3, 3, 2021, 5, 'ddddd', 'afriyudiyudi.jpg'),
('122', '22222', 'wwwwww', 1, 1, 1, 1, 2020, 0, 'wwww', 'dwi.jpg'),
('23', '5343242445', 'Deep Learning', 4, 1, 2, 3, 2020, 8, 'Deep Learning merupakan salah satu cabang dari artificial intelegense', 'Deep-Learnig.png'),
('34', '333333', '333333', 4, 4, 2, 3, 2020, 0, '33333', NULL),
('4', '1244242', 'Belajar Iqro', 1, 1, 1, 2, 2017, 21, '', NULL),
('5', '1234', 'Teknik Nuklir', 5, 4, 3, 2, 2019, 17, '', NULL),
('6', '1244242', 'Bentangkan Sayap', 6, 1, 1, 2, 2012, 20, '', NULL);
...
(194, 77, '2020-11-28', 53, 5, 159125),
(195, 78, '2020-11-28', 1286, 5, 3858125),
(196, 81, '2020-11-28', 51, 5, 153125),
(197, 81, '2020-11-28', 51, 5, 153125),
(198, 81, '2020-11-28', 51, 5, 153125),
(199, 80, '2020-11-28', 53, 5, 159125),
(200, 80, '2020-11-28', 53, 5, 159125),
(201, 79, '2020-12-07', 1295, 5, 3885125),
(202, 82, '2020-12-07', 5, 5, 15000);
...
('admin', 'feryzalsyah', 'XUE73TBORI8ZN2MYQJF1H64LGAV50PKC9SWD.jpg', 'L', 'bantul', 'admin', 2, '053xxxx', 'testing');
...
(77, '2017-05-21', 'ANGG000005', '2020-10-06', 1, 1),
(78, '2017-05-21', 'ANGG000003', '2017-05-22', 1, 1),
(79, '2017-05-21', 'ANGG000003', '2017-05-22', 2, 1),
(80, '2020-10-05', 'ANGG000005', '2020-10-06', 1, 1),
(81, '2020-10-05', 'ANGG000004', '2020-10-08', 1, 1),
(82, '2020-11-28', 'ANGG000006', '2020-12-02', 1, 1),
(83, '2020-11-28', 'ANGG000005', '2020-12-03', 1, 0),
(84, '2020-12-02', 'ANGG000004', '2020-12-03', 1, 0),
(85, '2020-12-15', 'ANGG000003', '2020-12-16', -1, 0);
...
--
ALTER TABLE `tb_detail_buku`
  MODIFY `id_detail_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `tb_detail_pinjam`
--
ALTER TABLE `tb_detail_pinjam`
  MODIFY `id_detail_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `tb_kembali`
  MODIFY `id_kembali` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
...
--
ALTER TABLE `tb_rak`
  MODIFY `no_rak` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
