...
class Petugas extends MY_Controller
{
	...
	public function index()
	{
		...
		if (!empty($cek) && $stts == 'admin') {
			...
			$data['desc'] = "Data Master Admin, Menampilkan data admin Perpustakaan";
	...
	public function create()
	{
		...
		if (!empty($cek) && $stts == 'admin') {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$data['pointer'] = "Petugas";
				$data['classicon'] = "fa fa-book";
				$data['main_bread'] = "Data Admin";
				$data['sub_bread'] = "Tambah Admin";
				$data['desc'] = "Data Master Admin, Menampilkan data Admin Perpustakaan";
				...
				if (empty($gambar)) {
					...
					if ($isi == 0) {
						...
						$data2 = array(
							'username' => $this->input->post('id_petugas'),
							'password' => $pass,
