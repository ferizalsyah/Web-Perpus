...
class Home extends MY_Controller
{
	...
	public function index()
	{
		...
		$data['count_buku'] = $this->db->query("SELECT * FROM tb_buku")->num_rows();
		$data['count_pinjam'] = $this->db->query("SELECT * FROM tb_pinjam")->num_rows();
		$data['count_kembali'] = $this->db->query("SELECT * FROM tb_kembali")->num_rows();
