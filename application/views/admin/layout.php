...
<body class="hold-transition skin-purple sidebar-mini">
  <div class="wrapper">
        ...
        <div class="user-panel" style="height: 50px;">
          ...
          foreach ($log as $key => $value) { ?>
            ...
            <div class="pull-left info">
              ...
              <!-- Status -->
              <a href="#">
                <i class="fa fa-circle text-success"></i>Aktif</a>
            </div>
          <?php
          }
          ?>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url(); ?>admin/Kelas"><i class="fa fa-building-o"></i>Data Prodi</a></li>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <!-- <strong>Published 2018 by <a href="https://www.sarjanakomedi.com">SarjanaKomedi.com</a>.</strong>  -->
    </footer>
