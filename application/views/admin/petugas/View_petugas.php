    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Anda akan menghapus Data Admin ini</p>
...
<div class="box box-solid box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-book"></i> Daftar Admin</h3>
    ...
    <div class="box-body">
        <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Petugas/create" class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Petugas"><i class="fa fa-plus"></i> Tambah Admin</a></div>
    ...
    <div class="box-footer">
        Menampilkan daftar Admin, untuk melihat detail Petugas klik tombol +, mengedit dan menghapus Admin klik tombol pada kolom pilihan.
    </div><!-- box-footer -->
</div><!-- /.box -->