    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/Anggota/update" role="form">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" value="<?php echo $anggota['email']; ?>" class="form-control" name="email" placeholder="Email">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">Password</label>
          <div class="col-sm-4">
            <input type="text" value="<?php echo $anggota['password']; ?>" class="form-control" name="password" placeholder="Password">
          </div>
        </div>
        <div class="form-group">
